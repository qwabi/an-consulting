...
const packages = [
  {
    name: "Standard",
    price: "R3,500",
    features: ["Accounting support", "Non-VAT Vendor services", "Monthly processing per bank statement"],
    icon: Package,
  },
  {
    name: "Silver",
    price: "R6,500",
    features: ["Accounting support", "VAT Vendor services", "Monthly processing of invoices and transactions"],
    icon: Briefcase,
  },
  {
    name: "Gold Package",
    ...
    features: [
      ...
      "Performance presentation & performance improvement coaching",
    ],
    icon: Building,
  },
]
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {packages.map((pkg, index) => (
            <motion.div
              key={pkg.name}
              className="bg-white p-8 rounded-lg shadow-lg relative overflow-hidden flex flex-col justify-between"
