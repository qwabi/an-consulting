...
export default function Contact() {
  ...
  return (
    <section id="contact-us" className="py-20 bg-[#233142] relative overflow-hidden">
      <motion.div
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          >
            <form onSubmit={handleSubmit} className="bg-white p-6 rounded-lg shadow-lg">
              <div className="mb-4">
                <label htmlFor="name" className="block text-[#233142] font-semibold mb-2">
                  Name
                </label>
                <input
                  type="text"
              ...
              <div className="mb-4">
                <label htmlFor="email" className="block text-[#233142] font-semibold mb-2">
                  Email
                </label>
                <input
                  type="email"
              ...
              <div className="mb-4">
                <label htmlFor="message" className="block text-[#233142] font-semibold mb-2">
                  Message
                </label>
                <textarea
                  id="message"
